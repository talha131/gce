function pivotAttendanceData() {
  ...
  var sourceSheet = ss.getSheetByName('Prof Talha - BEd 4 Year Semester 1 - Applications of ICT');
  if (!sourceSheet) {
  ...
  // Set date format
  reportSheet.getRange(5, 7, outputData.length - 4, sortedDates.length).setNumberFormat('ddd, mmm dd');
  ...
  reportSheet.getRange(6, 1, outputData.length - 5, outputData[0].length)
